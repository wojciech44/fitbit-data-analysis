...
-   Compile files inventory - `dataset_inventory.R` ✅
-   Read and merge sleep data (json and csv) - `sleep_inventory_parser.R` ✅
-   Sleep EDA - `sleep_analysis.Rmd` 🚧
...
This will load the required libraries and create inventory object, which is required in the next steps.
You want to have a full list of items exported from Fitbit/Google to get a proper overview of what you are dealing with. 
